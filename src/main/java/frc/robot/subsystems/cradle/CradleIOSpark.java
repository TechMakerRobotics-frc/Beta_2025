...
public class CradleIOSpark implements CradleIO {
  ...
  public CradleIOSpark() {
    alfa =
        new MotorIOSparkMax(
            CradleConstants.ALFA_ID, MotorType.kBrushless, true, 250, 10.0, 30, IdleMode.kBrake);
    beta =
        new MotorIOSparkMax(
            CradleConstants.BETA_ID, MotorType.kBrushless, true, 250, 10.0, 30, IdleMode.kBrake);
    gama =
        new MotorIOSparkMax(
            CradleConstants.GAMA_ID, MotorType.kBrushless, true, 250, 10.0, 30, IdleMode.kBrake);
  }
